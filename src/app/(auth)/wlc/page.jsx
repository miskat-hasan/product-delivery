    ...
    <section className="w-full min-h-screen flex items-center justify-center px-4 py-5 bg-[#F9F5EE]">
      <div className="max-w-[488px] w-full p-6 flex flex-col justify-center items-center shrink-0 rounded-3xl border border-primary-blue bg-white-50">
        ...
        <div className="w-full">
          <Link href={''} className="p-4 rounded-2xl bg-primary-blue shadow-[0_0_8px_2px_rgba(1,216,255,0.16),0_0_8px_2px_rgba(1,216,255,0.16)] text-white text-lg font-medium w-full flex items-center justify-center cursor-pointer hover:bg-primary-blue/85 disabled:opacity-50 disabled:cursor-not-allowed">
