...
const AirWaybillForm = () => {
  ...
  return (
    <div className="w-full max-w-[1218px] mx-auto py-10">
      <div className="w-full">
        <h5 className="flex text-lg font-bold justify-end">
          INCIDUNT NECESSITAT-OFFICIIS
        </h5>
        <div className="border-2 relative">
          <div className="absolute -top-[45px] flex">
            <p className="w-[61px] text-xs flex flex-col justify-end text-end font-bold">
              INCIDU NT
            </p>
            <div className="w-[61px] h-[45px] text-xs text-center flex flex-col justify-end font-bold border-l-2 border-r-2">
              VOLUPTA TEM
            </div>
          </div>
          {/* separator */}
          <div className="w-full flex border-b-2">
            ...
            <div className="border-r-2 left-side flex flex-col">
              <div className="grid grid-cols-2">
                ...
                <div className="text-black text-sm border-b-2 border-l-2 flex justify-between flex-col items-center h-[50px]">
                  <p>Shipper&rsquo;s Account Number</p>
                  <p className="text-xl">21345678976543245678</p>
                </div>
            ...
            <div className="flex flex-col right-side">
              ...
              <div className="border-t-2 px-2 text-sm mt-auto">
          ...
          <div className="w-full flex border-b-2">
            ...
            <div className="left-side">
              <div className="grid grid-cols-2">
                ...
                <div className="text-black text-sm border-b-2 border-l-2 flex justify-between flex-col items-center h-[50px] bg-[#DFDFDF]">
                  <p>Consignee&rsquo;s Account Number</p>
                  <p className="text-xl">234567898765</p>
                </div>
                <div className="px-4 text-xl">
                  <p>IUSTO DOLOR QUIS FUG</p>
                </div>
            ...
            {/* right */}
            <div className="right-side px-2 text-[11px] border-l-2">
          ...
          <div className="w-full flex">
            {/* left */}
            <div className="left-side flex flex-col border-r-2 border-b-2 px-2">
            ...
            <div className="right-side border-b-2">
              <div className="flex relative">
                <div className="absolute flex flex-col text-[11.75px] top-0.5 left-5 text-nowrap">
                  ...
                  <p className="text-lg">12345675</p>
                </div>
              ...
              <div className="flex">
                ...
                <div className="h-[25.77px] flex-1 border-l-2 border-r-2">
                  EST DOLOR EST SAEPE
                </div>
          ...
          <div className="w-full flex">
            ...
            <div className="left-side flex border-b-2 h-[96.471px]">
              ...
              <div>
                ...
                <div className="pt-3 px-2">asdfgdsa</div>
              </div>
          ...
          <div className="h-[553.626px] border-b-2 flex">
            <div className="w-[75.602px] border-r-2 flex justify-between flex-col">
              <div>
                ...
                <div className="p-1">fghfdsafghf</div>
              </div>
            ...
            <div className="w-[132.303px] border-r-2 flex justify-between flex-col">
              <div>
                ...
                <div className="p-1">sdfhjkhgfds</div>
              </div>
              <div className="w-full h-[68px] border-t-2" />
            </div>
            ...
            <div className="flex">
              ...
              <div className="w-[130.334px] border-r-2 flex flex-col">
                <div>
                  ...
                  <div className="p-1 border-l-2">sadfkhgfds</div>
                </div>
            ...
            <div className="w-[132.303px] border-r-2">
              <div>
                ...
                <div className="p-1">dfghgfds</div>
              </div>
            </div>
            <div className="w-[18.9px] bg-[#D9D9D9] border-r-2" />
            <div className="w-[151.204px] border-r-2">
              ...
              <div className="p-1">sdfghjgfd</div>
            </div>
            <div className="w-[18.9px] bg-[#D9D9D9] border-r-2" />
            <div className="w-[226.806px] border-r-2 flex flex-col justify-between">
              <div>
                ...
                <div className="p-1">dfghjkhgfd</div>
              </div>
              <div className="w-full h-[68px] border-t-2" />
            </div>
            <div className="w-[18.9px] bg-[#D9D9D9] border-r-2" />
          ...
          <div className="w-full flex">
            ...
            <div className="mini-left-side shrink-0 border-r-2">
              ...
              <div className="border-b-2">
                ...
                <div className="grid grid-cols-2">
                  <div className="border-r-2 h-[49.023px] p-1">dffdssdfdsf</div>
