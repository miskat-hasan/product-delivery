...
const AirWaybillPreview = () => {
  ...
  const captureForm = async () => {
    ...
    const canvas = await html2canvas(element, {
      ...
      onclone: (doc) => {
        ...
        // Freeze fonts + spacing
        cloned.style.fontKerning = "none";
        cloned.style.fontFeatureSettings = "normal";
  ...
  return (
    <div id="capture-area">
      <div id="capture-area" className="w-full max-w-[1418px] mx-auto py-10">
