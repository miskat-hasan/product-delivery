...
const AwbForm = () => {
  ...
  const onSubmit = (data) => {
    ...
    if (!logoFile && awbFormData?.data?.logo) {
      formData.append("existing_image", awbFormData?.data?.logo);
    }
  ...
  // ── Skeleton loader ─────────────────────────────────────────────
  if (awbFormDataLoading) {
    return <AwbFormSkeleton />;
  }
...
const SkeletonBox = ({ h = "h-10", w = "w-full" }) => (
  <div className={`${w} ${h} rounded-xl bg-gray-200 animate-pulse`} />
);

const SkeletonCard = ({ title, rows = 2 }) => (
  <div className="bg-white rounded-[14px] p-2 lg:p-4 shadow-sm space-y-3">
...
const AwbFormSkeleton = () => (
  <section>
    ...
    <div className="grid grid-cols-2 gap-2 lg:gap-4">
      ...
      <div className="space-y-2 max-md:col-span-2">
        ...
        <div className="bg-white rounded-[14px] p-2 lg:p-4 shadow-sm space-y-3">
          ...
          <SkeletonBox />
          <div className="bg-gray-50 rounded-[14px] p-2 space-y-3">
          ...
          <SkeletonBox />
          <div className="bg-gray-50 rounded-[14px] p-2 space-y-2">
      ...
      <div className="space-y-2 max-md:col-span-2">
        ...
        {/* Charges declaration */}
        <div className="bg-white rounded-[14px] p-2 lg:p-4 shadow-sm space-y-3">
          <div className="h-6 w-44 rounded-lg bg-gray-200 animate-pulse" />
          <div className="flex gap-2">
            <SkeletonBox w="w-1/3" />
            <SkeletonBox w="w-1/3" />
          </div>
      ...
      {/* FULL WIDTH — Handling info */}
      <div className="col-span-2 bg-white rounded-[14px] p-2 lg:p-4 shadow-sm space-y-3">
        <div className="h-6 w-48 rounded-lg bg-gray-200 animate-pulse" />
        <SkeletonBox h="h-24" />
        <SkeletonBox w="w-1/3" />
      </div>

      {/* FULL WIDTH — Rate description */}
      <div className="col-span-2 bg-white rounded-[14px] p-2 lg:p-4 shadow-sm space-y-3">
      ...
      <div className="space-y-2 max-md:col-span-2">
        ...
        <div className="bg-white rounded-[14px] p-2 lg:p-4 shadow-sm space-y-3">
          <div className="h-6 w-40 rounded-lg bg-gray-200 animate-pulse" />
          {["Prepaid", "Collect"].map((s) => (
            <div key={s} className="bg-gray-50 rounded-[14px] p-2 space-y-3">
    ...
    {/* Submit row skeleton */}
    <div className="flex justify-end gap-5 my-7 pt-7">
      <div className="h-14 w-[300px] rounded-2xl bg-gray-200 animate-pulse" />
      <div className="h-14 w-[300px] rounded-2xl bg-gray-200 animate-pulse" />
    </div>
  </section>
);